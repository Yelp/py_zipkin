...
@mock.patch('python_zipkin.thread_local._thread_local.zipkin_attrs', ['foo'])
...
@mock.patch('python_zipkin.thread_local._thread_local.zipkin_attrs', [])
...
@mock.patch(
    'python_zipkin.thread_local._thread_local.zipkin_attrs', ['foo', 'bar']
)
